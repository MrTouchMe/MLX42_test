...
#    Updated: 2024/04/05 01:43:14 by dgiurgev         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CC			=		cc
SRC			=		src/main.c src/parse.c src/map_to_screen.c  src/keybinds.c src/keybinds_helper.c src/load_png.c src/load_assets.c src/ft_hook.c src/ft_move.c src/map_checker.c src/map_checker_helper.c
BIN			=		bin
